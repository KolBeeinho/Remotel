...
const MobileTeam: React.FC = () => {
  ...
  return (
    <div className="relative min-h-[65em] lg:hidden">
      {/* Lekerekített rész */}
      <svg
      ...
      >
        ...
        <h2 className="mb-4 mt-12 text-center text-[8vw] font-[700] sm:text-[6vw]">
          {t.servicesh2}
        </h2>
        <p className="mx-4 mb-20 text-center text-[3.5vw] font-[400] sm:text-[3vw]">
          {t.servicesp}
        </p>
        {/* Szolgáltatások */}
        <Carousel />
