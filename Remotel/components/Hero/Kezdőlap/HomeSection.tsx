  ...
  return (
    <section className="ml-[3.5vw] min-h-[55rem] pt-8 sm:min-h-[60rem] md:pt-0 2xl:min-h-[80rem]">
      ...
      <Transition
        ...
        as="div"
      >
        <div className="blurtab relative z-0 mt-32 flex max-h-[30em] max-w-[55%] select-none flex-col space-y-4 p-4 font-[800] text-[#2F2A45] sm:max-h-[50em] md:mt-[8em] md:max-w-[45%] lg:max-w-[35%] xl:max-w-[30%] 2xl:max-w-[25%]">
          <h1 className="mx-2 mt-6 text-[5vw] font-[800] sm:text-[4.5vw] md:mx-6 md:text-[4vw] lg:text-[3.5vw] xl:text-[3vw] 2xl:text-[2.5vw]">
            {t.homeh1}
          </h1>
          <p className="ml-3 pb-24 text-[3.5vw] font-[400] sm:pb-32 sm:text-[3vw] md:mx-8 md:pb-40 md:text-[2.5vw] xl:text-[1.4vw]">
            {t.homep}
          </p>
          <a
