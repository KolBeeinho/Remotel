...
const AboutUs: React.FC = () => {
  ...
  return (
    <section
      className="min-h-[25em] bg-[#2F2A45] p-4 text-white xl:min-h-[40rem]"
      id={t.aboutusid}
    >
      <Transition
        show={transition}
      ...
      >
        ...
        <p className="mx-4 mb-10 text-justify text-[3.5vw] md:max-w-[60%] md:text-[2.5vw] lg:text-[2.25vw] xl:text-[2vw] 2xl:text-[1.75vw]">
