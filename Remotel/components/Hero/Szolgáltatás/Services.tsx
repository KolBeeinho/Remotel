...
const Services: React.FC = () => {
  ...
  return (
    <section
      className="bg-[#2F2A45] pb-20 text-white lg:min-h-[85rem]"
      id={t.servicesid}
    >
      <MobileServices />
      <div className="relative hidden lg:block">
        {/* Lekerekített rész */}
        <svg
          className="absolute top-0 z-[-1] hidden -translate-y-[80%] transform lg:block"
          width="100%"
        ...
        <Transition
          ...
          as="div"
        >
          <h2 className="mb-4 mt-8 select-none text-center text-[5vw] font-[700] xl:text-[4vw] 2xl:text-[3.5vw]">
            {t.servicesh2}
          </h2>
